...
Note: In actuality bracket characters are not used but instead unused0 is paired with unused1.
...
class InsertionConverter(object):
    ...
    def __init__(
        ...
        Args:
          ...
          tokenizer_name: Name of HF tokenizer.
    ...
    def create_insertion_example(
        ...
        Returns:
           A dictionary of features needed by the PyTorch insertion model.
        """
        ...
        if target_tokens and self._tokenizer.mask_token not in masked_tokens:
            ...
            if self._do_random_mask:
                ...
                for index in indexes:
                    masked_tokens[index] = self._tokenizer.mask_token
